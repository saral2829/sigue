                  ...
                  <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 col-md-8">
                        <input type="nombre" required class="form-control" name="nombre_producto" id="nombre_producto" placeholder="Nombre de producto" value="<?php echo $oproducto->nombre_producto ?>">
