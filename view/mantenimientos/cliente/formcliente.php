        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo isset($_GET['id']) ? 'EDITAR' : 'NUEVO' ; ?> CLIENTE</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="formcliente" name="formcliente" method="POST">
              ...
              <div class="box-body" id="div_juridico" <?php echo isset($ver_juridico)? (($ver_juridico == true) ? '' : 'hidden' ) : '' ?>>
                <div class="form-group">
              ...
              <div class="box-body"> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <input type="checkbox" name="empleado" id="empleado" <?php echo isset($ocliente->empleado)? (($ocliente->empleado=='1') ? 'checked' :'' ): ''; ?> >
                  </div>
                </div>
                <div class="form-group" id="div_empleado" <?php echo isset($ocliente->empleado)? (($ocliente->empleado == '0' or $ocliente->empleado == null ) ? 'hidden' : '' ): '' ?> >
                  <label for="text" class="col-sm-2 control-label">Area</label>

                  <div class="col-sm-10">
                    <select class="form-control" name="area" id="area">
                    <?php foreach ($lareas as $area): ?>
                      <option <?php echo isset($ocliente->are_id)?(($area->id_area == $ocliente->area_id) ? 'selected' : ''): '' ?> value="<?php echo $area->id_area ?>"><?php echo $area->nombre_area ?></option>    
                    <?php endforeach ?>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      ...
                      <input type="checkbox" name="proveedor" id="proveedor" <?php echo isset($ocliente->proveedor)?(($ocliente->proveedor=='1') ? 'checked' :'' ): '' ?> >
                  </div>
                </div>
  
                <div class="form-group" id="div_referencia" <?php echo isset($ocliente->caract_ref) ? 'hidden' : '' ; ?> >
              ...
              <div class="box-footer">
                <a href="index.php?page=mantenimientos&accion=panelcliente" class="btn btn-danger" role="button">Regresar <span class="glyphicon glyphicon-arrow-left"></span></a>
