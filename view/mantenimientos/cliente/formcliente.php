        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo ($_GET['id'] == null) ? 'NUEVO' : 'EDITAR' ; ?> CLIENTE</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="formcliente" name="formcliente" method="POST">
              ...
              <div class="box-body"> 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <input type="checkbox" name="empleado" id="empleado" <?php echo ($ocliente->empleado=='1') ? 'checked' :'' ; ?> >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      ...
                      <input type="checkbox" name="proveedor" id="proveedor" <?php echo ($ocliente->proveedor=='1') ? 'checked' :'' ; ?> >
                  </div>
                </div>
