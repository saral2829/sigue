            ...
            <div class="box-body" >
              <div class="form form-horizontal">
                <div class="form-group">
                  <label class="control-label col-md-2 col-sm-3">Sucursal:</label>
                ...
                <div class="form-group">
                  <label class="control-label col-md-2 col-sm-3">Almacen:</label>
                  <div class="col-md-10 col-sm-9">
...
<!-- Page script -->
<script src="js/almacen/almacen.js"></script>
</body>
</html>